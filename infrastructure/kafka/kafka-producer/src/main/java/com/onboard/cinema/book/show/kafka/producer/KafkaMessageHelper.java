package com.onboard.cinema.book.show.kafka.producer;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.onboard.cinema.book.show.booking.service.domain.exception.BookDomainException;
...
public class KafkaMessageHelper {
    ...
    public <T> T getOrderEventPayload(String payload, Class<T> outputType) {
        try {
            ...
            throw new BookDomainException("Could not read " + outputType.getName() + " object!", e);
        }
    }
